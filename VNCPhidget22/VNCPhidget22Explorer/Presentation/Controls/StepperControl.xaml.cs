...
namespace VNCPhidget22Explorer.Presentation.Controls
{
    public partial class StepperControl : ViewBase, IInstanceCountV
    {
        ...
        public StepperControl()
        {
            ...
            // ViewModel = (IStepperControlViewModel)DataContext;

            // Can create directly
            // ViewModel = StepperControlViewModel();
        ...
        // public StepperControl(IStepperControlViewModel viewModel)
        // {
        ...
        private static object OnCoerceIsAttached(DependencyObject o, object value)
        {
            StepperControl stepperControl = o as StepperControl;
            if (stepperControl != null)
                return stepperControl.OnCoerceIsAttached((Boolean)value);
            else
                return value;
        }
        ...
        private static void OnIsAttachedChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            StepperControl stepperControl = o as StepperControl;
            if (stepperControl != null)
                stepperControl.OnIsAttachedChanged((Boolean)e.OldValue, (Boolean)e.NewValue);
        }
        ...
        public void UpdateProperties(StepperEx servo)
        {
