...
namespace VNCPhidgets22Explorer
{
    public class Common : VNC.Core.Common
    {
        ...
        public const string APPLICATION_NAME = "VNCPhidgets22Explorer";
        public new const string LOG_CATEGORY = "VNCPhidgets22Explorer";

        public const string cCONFIG_FILE = @"C:\temp\VNCPhidgets22Explorer_Config.xml";
