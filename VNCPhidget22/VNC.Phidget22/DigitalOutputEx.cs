...
namespace VNC.Phidget22
{
    public class DigitalOutputEx : Phidgets.DigitalOutput, INotifyPropertyChanged
    {
        ...
        private void DigitalOutputEx_Attach(object sender, AttachEventArgs e)
        {
        ...
        private void DigitalOutputEx_PropertyChange(object sender, PropertyChangeEventArgs e)
        {
        ...
        private void DigitalOutputEx_Detach(object sender, DetachEventArgs e)
        {
            if (LogPhidgetEvents)
            {
                try
        ...
        private void DigitalOutputEx_Error(object sender, ErrorEventArgs e)
        {
            if (LogErrorEvents)
            {
                try
