...
namespace VNC.Phidget22.Ex
{
    public class PowerGuardEx : Phidgets.PowerGuard, INotifyPropertyChanged
    {
        ...
        private readonly PowerGuardConfiguration _PowerGuardConfiguration;
        ...
        public PowerGuardEx(int serialNumber, PowerGuardConfiguration PowerGuardConfiguration, IEventAggregator eventAggregator)
        {
            long startTicks = 0;
            ...
            _PowerGuardConfiguration = PowerGuardConfiguration;
        ...
        private void InitializePhidget()
        {
            ...
            Channel = _PowerGuardConfiguration.Channel;
            IsRemote = true;
            ...
            try
            {
                ...
                if (LogPerformanceSequence)
                {
                    startTicks = Log.Trace(
                        ...
                        $" PowerGuardSequence:>{PowerGuardSequence.Name}<" +
                ...
                {
                    for (int actionLoop = 0; actionLoop < PowerGuardSequence.ActionLoops; actionLoop++)
                    {
                        if (PowerGuardSequence.StartActionLoopSequences is not null)
                        {
                            ...
                            foreach (PhidgetDeviceClassSequence sequence in PowerGuardSequence.StartActionLoopSequences)
                            {
                        ...
                        if (PowerGuardSequence.EndActionLoopSequences is not null)
                        {
                            ...
                            foreach (PhidgetDeviceClassSequence sequence in PowerGuardSequence.EndActionLoopSequences)
                            {
                                await player.ExecutePhidgetDeviceSequence(sequence);
                            }
                        }
