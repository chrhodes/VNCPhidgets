                ...
                if (PowerGuardSequence.Actions is not null)
                {
                    for (int actionLoop = 0; actionLoop < PowerGuardSequence.ActionLoops; actionLoop++)
                    {
                        if (PowerGuardSequence.StartActionLoopSequences is not null)
                        {
                            ...
                            foreach (DeviceClassSequence sequence in PowerGuardSequence.StartActionLoopSequences)
                            {
                        ...
                        if (PowerGuardSequence.EndActionLoopSequences is not null)
                        {
                            ...
                            foreach (DeviceClassSequence sequence in PowerGuardSequence.EndActionLoopSequences)
                            {
                                await player.ExecutePerformanceSequence(sequence);
                            }
                        }
