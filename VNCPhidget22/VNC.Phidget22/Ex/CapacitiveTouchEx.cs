...
namespace VNC.Phidget22.Ex
{
    public class CapacitiveTouchEx : Phidgets.CapacitiveTouch, INotifyPropertyChanged
    {
        ...
        private readonly CapacitiveTouchConfiguration _CapacitiveTouchConfiguration;
        ...
        public CapacitiveTouchEx(int serialNumber, CapacitiveTouchConfiguration CapacitiveTouchConfiguration, IEventAggregator eventAggregator)
        {
            long startTicks = 0;
            ...
            _CapacitiveTouchConfiguration = CapacitiveTouchConfiguration;
        ...
        private void InitializePhidget()
        {
            ...
            Channel = _CapacitiveTouchConfiguration.Channel;
            IsRemote = true;
                ...
                if (CapacitiveTouchSequence.Actions is not null)
                {
                    for (int actionLoop = 0; actionLoop < CapacitiveTouchSequence.ActionLoops; actionLoop++)
                    {
                        if (CapacitiveTouchSequence.StartActionLoopSequences is not null)
                        {
                            ...
                            foreach (PerformanceSequence sequence in CapacitiveTouchSequence.StartActionLoopSequences)
                            {
                        ...
                        if (CapacitiveTouchSequence.EndActionLoopSequences is not null)
                        {
                            ...
                            foreach (PerformanceSequence sequence in CapacitiveTouchSequence.EndActionLoopSequences)
                            {
                                await player.ExecutePerformanceSequence(sequence);
                            }
                        }
