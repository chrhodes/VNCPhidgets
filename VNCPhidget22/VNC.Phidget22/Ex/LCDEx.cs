...
namespace VNC.Phidget22.Ex
{
    public class LCDEx : Phidgets.LCD, INotifyPropertyChanged
    {
        ...
        private readonly LCDConfiguration _LCDConfiguration;
        ...
        public LCDEx(int serialNumber, LCDConfiguration LCDConfiguration, IEventAggregator eventAggregator)
        {
            long startTicks = 0;
            ...
            _LCDConfiguration = LCDConfiguration;
        ...
        private void InitializePhidget()
        {
            ...
            Channel = _LCDConfiguration.Channel;
            IsRemote = true;
                ...
                if (LCDSequence.Actions is not null)
                {
                    for (int actionLoop = 0; actionLoop < LCDSequence.ActionLoops; actionLoop++)
                    {
                        if (LCDSequence.StartActionLoopSequences is not null)
                        {
                            ...
                            foreach (DeviceClassSequence sequence in LCDSequence.StartActionLoopSequences)
                            {
                        ...
                        if (LCDSequence.EndActionLoopSequences is not null)
                        {
                            ...
                            foreach (DeviceClassSequence sequence in LCDSequence.EndActionLoopSequences)
                            {
                                await player.ExecutePerformanceSequence(sequence);
                            }
                        }
