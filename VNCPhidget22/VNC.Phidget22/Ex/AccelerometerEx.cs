                ...
                if (accelerometerSequence.Actions is not null)
                {
                    for (int actionLoop = 0; actionLoop < accelerometerSequence.ActionLoops; actionLoop++)
                    {
                        if (accelerometerSequence.StartActionLoopSequences is not null)
                        {
                            ...
                            foreach (PerformanceSequence sequence in accelerometerSequence.StartActionLoopSequences)
                            {
                        ...
                        if (accelerometerSequence.EndActionLoopSequences is not null)
                        {
                            ...
                            foreach (PerformanceSequence sequence in accelerometerSequence.EndActionLoopSequences)
                            {
                                await player.ExecutePerformanceSequence(sequence);
                            }
                        }
