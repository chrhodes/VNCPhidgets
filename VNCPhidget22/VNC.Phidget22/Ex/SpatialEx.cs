...
namespace VNC.Phidget22.Ex
{
    public class SpatialEx : Phidgets.Spatial, INotifyPropertyChanged
    {
        ...
        public SpatialEx(Int32 serialNumber, SpatialConfiguration configuration, IEventAggregator eventAggregator)
        {
            long startTicks = 0;
        ...
        public async Task RunActionLoops(SpatialSequence spatialSequence)
        {
            try
            {
                ...
                {
                    for (Int32 actionLoop = 0; actionLoop < spatialSequence.ActionLoops; actionLoop++)
                    {
