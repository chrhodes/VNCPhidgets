            ...
            try
            {
                ...
                if (LogChannelAction)
                {
                    startTicks = Log.Trace(
                        ...
                        $" name:>{temperatureSensorSequence.Name}<" +
                ...
                if (temperatureSensorSequence.Actions is not null)
                {
                    for (int actionLoop = 0; actionLoop < temperatureSensorSequence.ActionLoops; actionLoop++)
                    {
                        if (temperatureSensorSequence.StartActionLoopSequences is not null)
                        {
                            ...
                            foreach (DeviceChannelSequence sequence in temperatureSensorSequence.StartActionLoopSequences)
                            {
                        ...
                        if (temperatureSensorSequence.EndActionLoopSequences is not null)
                        {
                            ...
                            foreach (DeviceChannelSequence sequence in temperatureSensorSequence.EndActionLoopSequences)
                            {
                                await player.ExecuteDeviceChannelSequence(sequence);
                            }
                        }
