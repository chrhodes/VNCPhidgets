    ...
    public class InterfaceKitSequenceConfig
    {
        public InterfaceKitSequence[] InterfaceKitSequences { get; set; } = new[]
        {
            ...
            new InterfaceKitSequence
            {
                ...
                NextSequence = new PerformanceSequence { Name = "psbc22_SequenceIK 1", ChannelClass = "IK" },
            ...
            new InterfaceKitSequence
            {
                ...
                NextSequence = new PerformanceSequence { Name = "psbc23_SequenceIK 1", ChannelClass = "IK" },
