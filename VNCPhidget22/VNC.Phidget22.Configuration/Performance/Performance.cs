...
namespace VNC.Phidget22.Configuration.Performance
{
    ...
    {
        public CopyOfPerformance()
        {
        }
        public CopyOfPerformance(CopyOfPerformance performance)
        {
            Name = performance.Name;
            Description = performance.Description;
            UsageNotes = performance.UsageNotes;
        ...
        /// <summary>
        /// Name of CopyOfPerformance.  Can be null if using embedded performance
        /// </summary>
        public string? Name { get; set; }

        /// <summary>
        /// Description of CopyOfPerformance
        /// </summary>
        public string? Description { get; set; }

        /// <summary>
        /// Notes on using CopyOfPerformance (optional)
        /// </summary>
        public string? UsageNotes { get; set; }

        /// <summary>
        /// CopyOfPerformance[] to call before executing DeviceChannelSequences[] and/or Performances[]
        /// before calling NextPerformance
        /// </summary>
        public CopyOfPerformance[]? BeforePerformanceLoopPerformances { get; set; }
        ...
        /// Performances to execute as part of this performance
        /// </summary>
        public CopyOfPerformance[]? Performances { get; set; }
        ...
        /// <summary>
        /// CopyOfPerformance[] to call after executing DeviceChannelSequences[]
        /// before calling NextSequence
        /// </summary>
        public CopyOfPerformance[]? AfterPerformanceLoopPerformances { get; set; }

        /// <summary>
        /// CopyOfPerformance to invoke at end of Loops of DeviceChannelSequences or Performances
        /// none or null to stop
        /// </summary>
        public CopyOfPerformance? NextPerformance { get; set; } = null;
    }
}
