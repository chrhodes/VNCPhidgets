...
namespace VNC.Phidget22.Configuration.Performance
{
    ...
    public class CopyOfChannelSequence
    {
        ...
        public CopyOfChannelSequence(string channelClass)
        {
            ChannelClass = channelClass;
        }

        public CopyOfChannelSequence(string channelClass, CopyOfChannelSequence channelSequence)
        {
            lock (_lock)
            {
                ChannelClass = channelClass;
        ...
        /// <summary>
        /// Name of sequence. Must be unique in ChannelClass
        /// Can be null if using embedded CopyOfChannelSequence
        /// </summary>
        public string? Name { get; set; }

        /// <summary>
        /// Description of CopyOfChannelSequence (optional)
        /// </summary>
        public string? Description { get; set; }

        /// <summary>
        /// Notes on using CopyOfChannelSequence (optional)
        /// </summary>
        public string? UsageNotes { get; set; }
