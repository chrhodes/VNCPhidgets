...
typedef enum
{
 ...
 PHIDUID_ADVANCEDSERVO_8MOTOR_VOLTAGE_CONTROL,
 ...
 PHIDUID_SPATIAL_ACCEL_GYRO_COMPASS_1044_1,
 ...
 */
__declspec (dllimport)
     int __stdcall CPhidgetEncoder_set_OnIndex_Handler (CPhidgetEncoderHandle phid, int (__stdcall * fptr) (CPhidgetEncoderHandle phid, void *userPtr, int index, int indexPosition), void *userPtr);
/**
 ...
 */
__declspec (dllimport)
     int __stdcall CPhidgetLED_getBrightness (CPhidgetLEDHandle phid, int index, double *brightness);
/**
 ...
 */
__declspec (dllimport)
     int __stdcall CPhidgetLED_setBrightness (CPhidgetLEDHandle phid, int index, double brightness);
/**
 ...
 */
__declspec (dllimport)
     int __stdcall CPhidgetLED_getCurrentLimitIndexed (CPhidgetLEDHandle phid, int index, double *limit);
/**
 ...
 */
__declspec (dllimport)
     int __stdcall CPhidgetLED_setCurrentLimitIndexed (CPhidgetLEDHandle phid, int index, double limit);
 ...
 */
__declspec (dllimport)
     int __stdcall CPhidgetRFID_getLastTag2 (CPhidgetRFIDHandle phid, char **tagString, CPhidgetRFID_Protocol * protocol);
/**
 ...
 */
__declspec (dllimport)
     int __stdcall CPhidgetRFID_write (CPhidgetRFIDHandle phid, char *tagString, CPhidgetRFID_Protocol protocol, int lock);
 ...
 */
__declspec (dllimport)
     int __stdcall CPhidgetRFID_set_OnTag2_Handler (CPhidgetRFIDHandle phid, int (__stdcall * fptr) (CPhidgetRFIDHandle phid, void *userPtr, char *tagString, CPhidgetRFID_Protocol protocol),
						    void *userPtr);
/**
 ...
 */
__declspec (dllimport)
     int __stdcall CPhidgetRFID_set_OnTagLost2_Handler (CPhidgetRFIDHandle phid, int (__stdcall * fptr) (CPhidgetRFIDHandle phid, void *userPtr, char *tagString, CPhidgetRFID_Protocol protocol),
							void *userPtr);
