...
API_PRETURN_HDR PhidgetNet_addServer(const char *, const char *, int, const char *, int);
API_PRETURN_HDR PhidgetNet_removeServer(const char *);

API_PRETURN_HDR PhidgetNet_enableServer(const char *name);
API_PRETURN_HDR PhidgetNet_disableServer(const char *name, int flags);

API_PRETURN_HDR PhidgetNet_setServerPassword(const char *name, const char *passwd);

API_PRETURN_HDR PhidgetNet_enableServerDiscovery(PhidgetServerType srvt);
API_PRETURN_HDR PhidgetNet_disableServerDiscovery(PhidgetServerType srvt);
...
API_PRETURN_HDR PhidgetNet_startServer(int flags, int af, const char *srvname, const char *address, int port,
...
API_PRETURN_HDR PhidgetNet_setProperty(const char *, const char *, ...);
API_PRETURN_HDR PhidgetNet_setPropertyv(const char *, const char *, va_list);
...
#ifdef NDEBUG
#define netlogdebug(...)
#define netlogcrit(...) PhidgetLog_loge(NULL, 0, NULL, NETLS, PHIDGET_LOG_CRITICAL, __VA_ARGS__)
#define netlogerr(...) PhidgetLog_loge(NULL, 0, NULL, NETLS, PHIDGET_LOG_ERROR, __VA_ARGS__)
#define netlogwarn(...) PhidgetLog_loge(NULL, 0, NULL, NETLS, PHIDGET_LOG_WARNING, __VA_ARGS__)
#define netloginfo(...) PhidgetLog_loge(NULL, 0, NULL, NETLS, PHIDGET_LOG_INFO, __VA_ARGS__)
#define netlogverbose(...) PhidgetLog_loge(NULL, 0, NULL, NETLS, PHIDGET_LOG_VERBOSE, __VA_ARGS__)
#else
 ...
 * Client Side API
 */
PhidgetReturnCode openNetworkChannel(PhidgetChannelHandle, PhidgetDeviceHandle, int index);
...
#define PHIDGET_NET_PROTOCOL_MINOR	1
...
PhidgetReturnCode openServerChannel(uint64_t, Phidget_ChannelClass, int, PhidgetNetConnHandle,
...
PhidgetReturnCode simpleWaitForReply(WaitForReply **, PhidgetReturnCode *, char **);
