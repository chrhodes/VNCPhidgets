...
PhidgetFirmwareUpgrade_getActualDeviceID(PhidgetFirmwareUpgradeHandle ch,
  Phidget_DeviceID *actualDeviceID) {
	...
	TESTPTRL(ch);
	TESTPTRL(actualDeviceID);
	TESTCHANNELCLASSL(ch, PHIDCHCLASS_FIRMWAREUPGRADE);
	TESTATTACHEDL(ch);
